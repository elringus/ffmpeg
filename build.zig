...
pub fn build(b: *std.build.Builder) void {
    ...
    const common_config = .{
        ...
        .CONFIG_AVIO_READING_EXAMPLE = 0,
        .CONFIG_DECODE_AUDIO_EXAMPLE = 0,
        .CONFIG_DECODE_VIDEO_EXAMPLE = 0,
        .CONFIG_DEMUXING_DECODING_EXAMPLE = 0,
        .CONFIG_ENCODE_AUDIO_EXAMPLE = 0,
        .CONFIG_ENCODE_VIDEO_EXAMPLE = 0,
        .CONFIG_EXTRACT_MVS_EXAMPLE = 0,
        .CONFIG_FILTER_AUDIO_EXAMPLE = 0,
        .CONFIG_FILTERING_AUDIO_EXAMPLE = 0,
        .CONFIG_FILTERING_VIDEO_EXAMPLE = 0,
        .CONFIG_HTTP_MULTICLIENT_EXAMPLE = 0,
        .CONFIG_HW_DECODE_EXAMPLE = 0,
        .CONFIG_METADATA_EXAMPLE = 0,
        .CONFIG_MUXING_EXAMPLE = 0,
        .CONFIG_QSVDEC_EXAMPLE = 0,
        .CONFIG_REMUXING_EXAMPLE = 0,
        .CONFIG_RESAMPLING_AUDIO_EXAMPLE = 0,
        .CONFIG_SCALING_VIDEO_EXAMPLE = 0,
        .CONFIG_TRANSCODE_AAC_EXAMPLE = 0,
        .CONFIG_TRANSCODING_EXAMPLE = 0,
